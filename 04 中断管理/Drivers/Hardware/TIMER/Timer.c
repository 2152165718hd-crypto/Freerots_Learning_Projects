...
void TIM3_Init(void)
{
    ...
    /* 诊断打印：验证实际的Period和Prescaler值 */
    printf("TIM3 Config - Prescaler: %lu, Period: %lu, Timer Clock: %luHz\r\n",
           htim3.Init.Prescaler,
           htim3.Init.Period,
           SystemCoreClock / (htim3.Init.Prescaler + 1));
...
void TIM4_Init(void)
{
    ...
    /* 设置预分频器：使时钟频率分频至10KHz */
    htim4.Init.Prescaler = (SystemCoreClock / 10000) - 1;
    ...
    /* 诊断打印：验证实际的Period和Prescaler值 */
    printf("TIM4 Config - Prescaler: %lu, Period: %lu, Timer Clock: %luHz\r\n",
           htim4.Init.Prescaler,
           htim4.Init.Period,
           SystemCoreClock / (htim4.Init.Prescaler + 1));
